...
UR_199909 <- UR %>%
  filter(date == "1999-09-01")
glimpse(UR_199909)
scatter <- ggplot(data = UR_199909) + 
  geom_point(mapping = aes(x = PopWtdRA_rank, y = unemployment_rate))
print(scatter + ggtitle("Sep 1999") + labs(caption = "Suggests no linear relationship", y = "Unemployment Rate", x = "Remoteness Rank"))
ggsave("RemoteEDA 2 Unemp+Remote Scatter 1999Sep.pdf")
